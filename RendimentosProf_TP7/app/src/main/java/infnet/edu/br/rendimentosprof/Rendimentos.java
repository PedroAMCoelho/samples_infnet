...
public Double descontoINSS (double salarioBruto){
    ...
    public String toString() {
        ...
        double porcDesc = this.getPorcDesc();
        DecimalFormat dft = new DecimalFormat("###,##0.00");
        String strporcDesc = dft.format(porcDesc) + "%";

        return "Data e Horário:" + df.format(new Date()) + "~" + "Número de Dependentes:" + this.numDepends + "~" + "Valor da Pensão:" + this.pensao + "~" + "Valor do Plano de Saúde:" + this.planoSaude + "~" + "Outros Descontos:" + this.outros + "~" + "Salário Líquido:" + this.getSalarioLiq() + "~" + "Total dos Descontos:" + this.getTotalDesc() + "~" + "Porcentagem de Descontos:" + strporcDesc + "\t \t \t \t \t";
